...
<%@ page import="mybean.data.showyySearch"%>
<jsp:useBean id="lookyy" class="mybean.data.showyySearch" scope="request"/>
<jsp:setProperty name="lookyy" property="name"/>
<html>
<head>
...
body{
 ...
 <div id="d1">
  <div class = "tableCenter">
	...
	<jsp:setProperty name="lookyy" property="pageSize" value="5"/>
	  <jsp:setProperty name="lookyy" property="showPage"/>
  <jsp:getProperty name="lookyy" property="presentPageResult"/>
  <br>
  <table class="change">
   <tr>
    <td>
     <form action="">
	  <input type=hidden name="showPage" value="<%=lookyy.getShowPage()-1%>">
