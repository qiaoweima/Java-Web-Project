...
<link rel="stylesheet" type="text/css" href="css/zxyy.css"/>
		<script>
...
<body>
		...
		<form method="post" action="/yayi/submit">
			&emsp;&emsp;姓名：  <input type="text" name="name" value="" placeholder="请输入姓名"/><br>
			&emsp;&emsp;年龄：  <input type="text" name="age" value="" placeholder="请输入年龄"/><br>
			&emsp;&emsp;性别：  男<input type="radio" name="sex" checked="checked" value="男"/>&emsp;&emsp;女<input type="radio" name="sex" value="女"/><br>
			&emsp;&emsp;医生：  <input type="text" name="doctor" value="请选择" readonly="readonly" id="doctor" value=""/><br>   
			 预约时间：<input name="time" value="请选择" readonly="readonly" id="time" value=""/><br>
			&emsp;&emsp; <p>备注：</p><textarea name="beizhu"></textarea><br>
