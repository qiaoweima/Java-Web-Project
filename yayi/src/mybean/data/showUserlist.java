	...
	public StringBuffer show(int page){
		...
		try{
			...
			for(int i = 1;i<=pageSize&&boo;i++){
				...
				str.append("<td><form action=\"/yayi/jieshou1\" method=\"post\"><input type=hidden name=\"jieshou\" value=\""+rs.getString(1)+","+rs.getString(2)+"\""+"><input type=submit name=\"\" value=\"管理员\" onclick=\"checkjs()\"><input type=hidden name=\"title\" value=\"userlist1\"></form>"
						+ "<br><form action=\"/yayi/jieshou1\" method=\"post\"><input type=hidden name=\"jieshou\" value=\""+rs.getString(1)+","+rs.getString(2)+"\""+"><input type=submit name=\"\" value=\"用户\" onclick=\"checkjs()\"><input type=hidden name=\"title\" value=\"userlist2\"></form></td>");
